...
pretrained_weights_path = './dataset/model_weights/Prithvi_100M.pt'
num_layers = 6
patch_size = 16
embed_dim = 768
num_heads = 8
...
experiment = 'multi_temporal_crop_experiment'
project_dir = './'
...
img_norm_cfg = dict(means=[
    ...
    494.905781, 815.239594, 924.335066, 2968.881459, 2634.621962, 1739.579917
                    ...
                    stds=[
                        ...
                        951.900334, 921.407808, 284.925432, 357.84876,
                        575.566823, 896.601013, 951.900334, 921.407808,
                        284.925432, 357.84876, 575.566823, 896.601013,
                        951.900334, 921.407808
                    ])
...
train_pipeline = [
    dict(type='LoadGeospatialImageFromFile',
         to_float32=True,
         channels_last=True),
...
CLASSES = ('Natural Vegetation', 'Forest', 'Corn', 'Soybeans', 'Wetlands',
...
evaluation = dict(interval=eval_epoch_interval,
                  metric='mIoU',
                  pre_eval=True,
                  save_best='mIoU',
                  by_epoch=True)
...
model = dict(type='TemporalEncoderDecoder',
             frozen_backbone=False,
             backbone=dict(type='TemporalViTEncoder',
                           ...
                           mlp_ratio=4.0,
                           norm_pix_loss=False),
             neck=dict(type='ConvTransformerTokensToEmbeddingNeck',
